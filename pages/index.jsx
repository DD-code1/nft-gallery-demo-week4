// import { read } from 'react-icons/fs'
...
const Home = () => {
  ...
  return (
    ...
    <div className="h-screen flex flex-col  bg-cyan-600 items-center justify-center py-8 gap-y-3">
      ...
      <div className="flex flex-col w-full justify-center items-center gap-y-2">
        ...
        <button className={"disabled:bg-slate-500 text-white cursor-pointer animate-pulse bg-blue-400 px-4 py-2 mt-3 rounded-sm w-1/5"} onClick={
          () => {
